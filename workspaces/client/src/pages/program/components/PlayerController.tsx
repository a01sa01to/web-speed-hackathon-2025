...
export const PlayerController = () => {
  ...
  return (
    <>
      <div className="q-div12">
        <div className="q-div13" />

        <div className="q-div14">
          <div className="q-div15">
            <div className="q-div16">
              {/* biome-ignore lint/a11y/noSvgWithoutTitle: <explanation> */}
              <svg className="q-svg" height={20} viewBox="0 0 24 24" width={20}
              ...
              <span className="q-span">ライブ配信</span>
            </div>
